define([
    ...
    angularAMD.controller('blackoutTempCtrl', ['$scope', '$ngConfirm','$http', '$location', '$state', '$sce', '$window', '$timeout', '$stateParams', function($scope, $ngConfirm,$http, $location, $state, $sce, $window, $timeout, $stateParams) {
