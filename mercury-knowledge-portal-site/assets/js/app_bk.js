...
var appCacheVersion = '12-10-19-2158';
...
eyMercuryKnowledgeApp.config(function($locationProvider,$stateProvider, $urlRouterProvider, $httpProvider) {
  ...
  $stateProvider
    ...
    .state('home', {
      url: "/SitePages/Test-Index.aspx/home",
      templateUrl: "urlSite/SiteAssets/mercury-knowledge-portal-site/assets/js/partials/beNewHomePartial.html?c=" + appCacheVersion,
      onEnter: function($location) { 
                    gtag('config', 'UA-132215702-1', {
                        'page_title': 'Home',
    ...
    .state('task-support', {
      url: "/SitePages/Test-Index.aspx/task-support",
    ...
    .state('big-switch', {
      url: "/SitePages/Test-Index.aspx/TheBigSwitch",
    ...
    .state('BlackoutTemplates', {
      url: '/SitePages/Test-Index.aspx/blackout-templates',
    ...
    .state('CoExistence', {
      url: '/SitePages/Test-Index.aspx/CoExistence',
    ...
    .state('ActionsToTake', {
      url: '/SitePages/Test-Index.aspx/actions-to-take',
    ...
    .state('FAQs', {
      url: '/SitePages/Test-Index.aspx/faqs',
    ...
    .state('engagement-lifecycle/individual', {
      url: "/SitePages/Test-Index.aspx/engagement-lifecycle/{tileTitle}/{businessUnit}/{serviceLine}",
    ...
    .state('engagement-lifecycle/individual-how-to/how-to', {
      url: "/SitePages/Test-Index.aspx/engagement-lifecycle/{tileTitle}/{businessUnit}/{serviceLine}/how-to-{howToTitle}",
    ...
    .state('engagement-lifecycle/individual-policy/policy-name', {
      url: "/SitePages/Test-Index.aspx/engagement-lifecycle/{tileTitle}/{businessUnit}/{serviceLine}/policy-{policyName}",
    ...
    .state('engagement-lifecycle/individual-guidance/guidance-name', {
      url: "/SitePages/Test-Index.aspx/engagement-lifecycle/{tileTitle}/{businessUnit}/{serviceLine}/guidance-{guidanceName}",
	...
	.state('policies-guidance', {
      url: "/SitePages/Test-Index.aspx/policies-and-guidance",
    ...
    .state('blog', {
      url: "/SitePages/Test-Index.aspx/blog/:id/:PageTitle",
    ...
    //$urlRouterProvider.otherwise("/SitePages/Test-Index.aspx/home");
